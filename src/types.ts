...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface RemoteErrorDetailsMap {
    'fund-portfolio/duplicate-holding': { readonly accountId: string; readonly fundCode: string }
    'fund-portfolio/rejected': { readonly operation: string }
    'fund-portfolio/unavailable': { readonly operation: string }
  }
}
...
export interface AccountEdit { id: AccountId; version: number; name: string }
export interface AccountRef { id: AccountId; version: number }
...
export interface MutationResult { ok: boolean }
export interface BackupFile { filename: string; json: string }
