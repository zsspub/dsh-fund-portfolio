...
await Promise.all([
  writeFile(resolve(root, 'lib/typert.host.js'), artifact.js),
  writeFile(resolve(root, 'lib/typert.host.d.ts'), artifact.dts),
  writeFile(resolve(root, 'lib/typert.remote-client.js'), artifact.remote.js),
...
const clientExternals = new Set(['react', 'react-dom', 'react/jsx-runtime'])
await build({
