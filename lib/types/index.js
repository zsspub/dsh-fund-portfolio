...
let FundPortfolioService = (() => {
    ...
    return class FundPortfolioService extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _allocationUpdate_decorators, { kind: "method", name: "allocationUpdate", static: false, private: false, access: { has: obj => "allocationUpdate" in obj, get: obj => obj.allocationUpdate }, metadata: _metadata }, null, _instanceExtraInitializers);
